...
*/
(function(){
  var buffer, bufferedMsgsFirst, renderer, scene, camera, light, render, controls, materialFront, material, blockMaterial, extrusionSettings, Outlines, Centroids, CACHED, GET, split$ = ''.split;
  buffer = [];
