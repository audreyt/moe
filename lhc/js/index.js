...
*/
(function(){
  var buffer, bufferedMsgsFirst, renderer, scene, camera, light, render, controls, materialFront, material, blockMaterial, extrusionSettings, Outlines, Centroids, CACHED, GET, split$ = ''.split, join$ = [].join;
  buffer = [];
  ...
  GET('./data/Outlines.json', function(it){
    return Outlines = it;
  });
  GET('./data/Centroids.json', function(it){
    return Centroids = it;
  });
