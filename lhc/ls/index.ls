...
CACHED = {}; GET = (url, data, onSuccess, dataType) ->
  ...
  $.get(url, data, (->
    ...
    #window.input x
GET \./data/Outlines.json -> Outlines := it
GET \./data/Centroids.json -> Centroids := it
