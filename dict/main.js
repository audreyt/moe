...
(function(){
  ...
  GET = function(url, data, onSuccess, dataType){
    ...
    return $.get(url, data, function(it){
      ...
      var x;
      x = replace$.call(decodeURIComponent(url), /\.json$/, '').replace(/^\w/, '');
      return window.input(x);
    });
  };
  try {
